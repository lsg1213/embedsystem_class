...
static ssize_t sjl_fpga7segment_write(struct file * file, const char * buf, size_t length, loff_t * ofs){
	...
	printk("sjl_fpga7segment_write: %d \n", num);
...
static long sjl_fpga7segment_ioctl(struct file * file, unsigned int cmd, unsigned long arg){
...
static struct file_operations sjl_fpga7segment_fops = {
	.owner = THIS_MODULE,
	.open = sjl_fpga7segment_open,
	.release = sjl_fpga7segment_release,
	//.read = sjl_fpga7segment_read,
	.write = sjl_fpga7segment_write,
	.unlocked_ioctl = sjl_fpga7segment_ioctl,
};

static struct miscdevice sjl_fpga7segment_driver = {
	.minor = MISC_DYNAMIC_MINOR,
	.name = "sjl_fpga7segment",
	.fops = &sjl_fpga7segment_fops,
};
